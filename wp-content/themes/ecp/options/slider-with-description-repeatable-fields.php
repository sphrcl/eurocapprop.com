...
function rooms_add_meta_boxes() {
	add_meta_box( 'repeatable-fields', 'Available Packages', 'rooms_repeatable_meta_box_display', 'page', 'normal', 'high');
}
...
<table id="repeatable-fieldset-one" width="100%">
	...
	<tbody>
		...
		<?php if ( $repeatable_fields ) : foreach ( $repeatable_fields as $field ) { ?>
			...
			<tr>		
				...
				<td>
					<textarea type="text" class="widefat" name="description[]" style="padding: 10px;"><?php if($field['description'] != '') echo esc_attr( $field['description'] ); ?></textarea>
				</td>
				<td>
		...
		<?php }	else : ?>
			...
			<tr>
				...
				<td><textarea type="text" class="widefat" name="description[]" style="padding: 10px;"></textarea></td>
	...
	<p><a id="add-row" class="button button-primary button-large" href="#">Add another</a></p>
